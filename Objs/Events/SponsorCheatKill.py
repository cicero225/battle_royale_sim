...
def func(Event, mainActor, state=None, participants=None, victims=None, sponsors=None):
    ...
    return (desc, [sponsors[0], mainActor], [mainActor.name]) # Second entry is the contestants or items named in desc, in desired display. Third is anyone who died. This is in strings.
