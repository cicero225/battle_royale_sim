...
def func(self, mainActor, state=None, participants=None, victims=None, sponsors=None):
    probKill = Event.DieOrEscapeProb1v1(mainActor, victims[0], state["settings"], defenseStat=(victims[0].stats['combat ability']*0.25+victims[0].stats['cleverness']*0.15))
    ...
    if random.random()<probKill:
        ...
        desc = mainActor.name+' shot an arrow at '+victims[0].name+" and killed "+Event.parseGenderObject(victims[0])+"."
        ...
        deadList = []
        desc = mainActor.name+' shot an arrow at '+victims[0].name+", but missed."
