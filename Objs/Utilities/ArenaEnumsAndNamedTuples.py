...
from typing import Any, NamedTuple, Dict, Optional, Iterable, Type, Union, TYPE_CHECKING
if TYPE_CHECKING:
...
class EventAnnouncement(NamedTuple):
    ...
    dead_here: Iterable[str] = None # which characters in this event are known to be dead. Otherwise dead characters in display_items will be block the announcement if block_if_any_contestant_dead is True.
