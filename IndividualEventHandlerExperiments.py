...
eventHandler.setEventWeightForSingleContestant("RecoversFromFever", "Akemi Homura", 10)
eventHandler.setEventWeightForSingleContestant("DiesFromFever", "Akemi Homura", 10)
eventHandler.setEventWeightForSingleContestant("FriendGivesMedicine", "Akemi Homura", 10)
eventHandler.banEventForSingleContestant("SickWithFever", "Akemi Homura")
state["events"]["SickWithFever"].eventStore["Akemi Homura"] = eventHandler #registers event chain

print(state["events"]["SickWithFever"].eventStore["Akemi Homura"].callbackReferences)
